...
{
    public async Task<Result<IEnumerable<Domain.Entity.Backup>>> HandleAsync(GetAllBackupsQuery query, RequestContext context, CancellationToken cancellationToken)
    {
